...
function Aura$1(node, childNodes) {
  this.node = node;
...
Aura$1.MAX_LIST_SIZE = 999;

Aura$1.prototype.splice = function splice(start, end) {
  var values = new Map();
  var ph = this.node;
...
function become(value) {
  ...
  if (value.length !== length) {
    majinbuu(this, value, Aura$1.MAX_LIST_SIZE);
  } else {
    for (; i < length--; i++) {
...
var optimist = function optimist(aura$$1, value) {
  ...
  if (value.length !== length) {
    majinbuu(aura$$1, value, Aura$1.MAX_LIST_SIZE);
  } else {
    for (var i = 0; i < length--; i++) {
...
var setAnyContent = function setAnyContent(node, childNodes) {
  var aura$$1 = new Aura$1(node, childNodes);
  var oldValue = void 0;
